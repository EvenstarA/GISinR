...
cpc <- get_inat_obs(taxon_name = "Trichostetha capensis",
                   bounds = c(-34.5, 18, -33, 19), # confined searches to the Western Cape region
                   maxresults = 400)
head(cpc)
```
...
ggplot() +
  ...
  theme(legend.key.width = unit(10.1, "cm"))  # plot the shape file to check that everything works and runs
```
